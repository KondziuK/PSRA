...
#
# Generated by export_simulation on Sat May 23 19:06:19 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './fos_cfd_ram.sh' script.

./fos_cfd_ram.sh -reset_run
...
./fos_cfd_ram.sh -noclean_files

For more information on the script, please type './fos_cfd_ram.sh -help'.
