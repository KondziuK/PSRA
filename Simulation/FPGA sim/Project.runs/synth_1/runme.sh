...
HD_PWD='C:/backup/FPGA/Project/Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fos_cfd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fos_cfd.tcl
