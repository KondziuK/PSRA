...
begin
  ...
  begin  
    vsync<=1'b0;
	 ...
	 $fclose(rgbfile);
    // Set you path !!!
    rgbfile = $fopen({"C:/backup/FPGA/pets_2006_ppm/in_",
                       vsc[11:0]/1000+8'h30,(vsc[11:0]%1000)/100+8'h30,(vsc[11:0]%100)/10+8'h30,vsc[11:0]%10+8'h30,".ppm"},"rb");
